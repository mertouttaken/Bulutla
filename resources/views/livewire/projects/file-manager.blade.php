  ...
  <div>
    <label for="projectFileInput" class="upload-box-label">
      ...
      <p class="upload-title">
        <span wire:loading.remove wire:target="uploadedFile">Dosya yüklemek için buraya <span>tıklayın</span></span>
        <span wire:loading wire:target="uploadedFile" style="color: #c084fc;">Dosya yükleniyor, lütfen bekleyin...</span>
      </p>
      <p class="upload-sub">ZIP, SCHEMATIC, YML, JSON, MAP, JAR paketleri desteklenir (Maks. 100 MB)</p>
      <input type="file" wire:model="uploadedFile" id="projectFileInput" style="display: none;">
    </label>
    @error('uploadedFile')
      ...
      <div class="file-item">
        ...
        <div class="file-actions">
          ...
          <button type="button" 
                  ...
                  wire:confirm="Bu dosyayı projeden silmek istediğinize emin misiniz?" 
                  class="file-destroy-btn">
