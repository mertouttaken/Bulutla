...
<div class="admin-edit-container">
  ...
  @if($errors->any())
    <div class="alert-box alert-danger">
      ...
      <button type="button" onclick="this.parentElement.remove()" style="background:none; border:none; color:#fca5a5; cursor:pointer; font-size:1rem;">✕</button>
    </div>
  @endif
  ...
  <div class="edit-grid">
    ...
    <div class="panel-box">
      ...
      <form action="{{ route('admin.users.update', $user->id) }}" method="POST" style="display: flex; flex-direction: column; gap: 20px; margin: 0;">
        @csrf
        @method('PUT')
