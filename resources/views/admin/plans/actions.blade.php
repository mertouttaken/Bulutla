...
<div class="admin-layout">
  ...
  <div class="admin-main">
    ...
    <main class="admin-content">
      ...
      @if ($errors->any())
        <div style="background: rgba(239, 68, 68, 0.15); border: 1px solid rgba(239, 68, 68, 0.35); color: #fca5a5; padding: 14px 20px; border-radius: 14px; font-size: 0.88rem;">
          ...
          <form action="{{ route('admin.plans.store') }}" method="POST">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="Örn: Pro" value="{{ old('name') }}" required>
              </div>

              <div class="form-group">
                <label>Slug</label>
                <input type="text" name="slug" class="form-control" placeholder="pro" value="{{ old('slug') }}" required>
              </div>

              <div class="form-group">
                <label>Aylık Ücret (₺)</label>
                <input type="number" step="0.01" name="price" class="form-control" placeholder="149.00" value="{{ old('price') }}" required>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" name="storage_limit" class="form-control" placeholder="Örn: 5 GB" value="{{ old('storage_limit') }}">
              </div>

              <div class="form-group">
                <label>Proje Limiti</label>
                <input type="number" name="project_limit" class="form-control" placeholder="5" value="{{ old('project_limit') }}">
              </div>

              <div class="form-group full">
                <label>Açıklama</label>
                <textarea name="description" class="form-control" placeholder="Plan hakkında kısa bilgilendirme...">{{ old('description') }}</textarea>
              </div>

              <div class="form-group full">
                <label>Özellikler (Virgülle ayırın)</label>
                <input type="text" name="features" class="form-control" placeholder="5 proje, 5 GB alan, Canlı destek" value="{{ old('features') }}">
              </div>
