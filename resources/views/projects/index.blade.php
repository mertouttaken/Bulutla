...
<div class="projects-container">
  ...
  @if(session('success'))
    <div class="alert-box">
      ...
      <button type="button" onclick="this.parentElement.remove()" style="background:none; border:none; color:#f3e8ff; cursor:pointer; font-size: 1rem;">✕</button>
    </div>
  @endif
  ...
  <div class="projects-grid" id="projectsList">
    ...
    @empty
      <div class="empty-state">
        ...
        <p>Yukarıdaki "+ Yeni Proje Oluştur" butonuna basarak ilk projeni oluşturabilirsin.</p>
      </div>
    @endforelse
  </div>
...
<div id="newProjectModal" class="modal-overlay" style="display: none;">
  <div class="modal-container">
    ...
    <form action="{{ route('projects.store') }}" method="POST" style="display: flex; flex-direction: column; gap: 16px; margin: 0;">
      @csrf
      <div class="form-group">
        <label for="pName">Proje Adı</label>
        <input type="text" name="name" id="pName" required placeholder="Örn: Survival Paketi" class="form-control">
      </div>
